    ...
    children: [
      {
        ...
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/project-1-the-kimball-method/',
      },
      {
        id: '3',
        name: 'Project 2 – Data warehouses vs. marts',
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/project-2-data-warehouses-vs-marts/',
      },
      {
        id: '4',
        name: 'Project 3 – The ETL Process',
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/project-3-the-etl-process/',
      },
      {
        id: '5',
        name: 'Project 4 – Modify the OLTP design',
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/project-4-oltp-modifications-to-erp-design/',
      },
      {
        id: '6',
      ...
      },
      {
        ...
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/transforming-data/',
      },
      {
        id: '8',
        name: 'Project 7 – MarkLogic',
        url:
          'https://rkjdatawarehousing.wordpress.com/projects/project-7-marklogic/',
      },
      {
        id: '9',
    ...
    children: [
      {
        ...
        url:
          'https://content.byui.edu/file/f0594919-9524-47eb-9f4d-5c7239c3c002/1/Lesson1Introduction.pdf',
      },
      {
        id: '22',
        name: 'Lesson 2 - The DOM and JQuery',
        url:
          'https://content.byui.edu/file/c67e59fd-990c-4adc-9232-8027f847c8b9/1/Lesson2Introduction.pdf',
      },
      {
        id: '23',
        name: 'Lesson 3 - Angular 2 Framework 1',
        url:
          'https://content.byui.edu/file/aa9b6af5-b882-48f5-8321-caca980e5ec9/1/Lesson3Introduction.pdf',
      },
      {
        id: '24',
        name: 'Lesson 4 - Angular 2 Framework 2',
        url:
          'https://content.byui.edu/file/2c4ddd6c-dce4-408d-b581-f254a13e4d10/1/Lesson4Introduction.pdf',
      },
      {
        id: '25',
        name: 'Lesson 5 - Angular 2 Framework 3',
        url:
          'https://content.byui.edu/file/66dc0765-22a7-4cd8-a184-942c607636fb/1/Lesson5Introduction.pdf',
      },
    ],
  },
  {
